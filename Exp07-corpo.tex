\titulo{CONTROLE DE TENSÃO DE UM CONVERSOR BUCK--BOOST} % Titulo em português
\title{VOLTAGE MODE CONTROL OF A BUCK--BOOST CONVERTER} % Título em inglês

\maketitle

\editorfootnote{Artigo compilado em {\today} às {\currenttime}h, referente ao experimento de número 06 da disciplina de Laboratório de Eletrônica de Potência -- ET76C, ministrada pelo Prof. Adriano Ruseler, Dr. Eng.\\
